namespace SetMouseLocationByKeyboard
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "Change Display Color";
            ...
            this.textBox1.Text = "Double press Ctrl key to launch grid. Navigate the grid using numbers. Hit Enter " +
    "to simulate left mouse click where the cursor is.  Press any other key to exit t" +
    "he grid.";
            // 
            // label2
            // 
            ...
            this.Name = "Form1";
            this.Text = "Set Mouse Location With Keyboard";
